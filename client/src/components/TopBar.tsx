...
export default function TopBar() {
  return (
    <div className="absolute top-0 left-0 w-full p-4 md:p-6 flex justify-between items-center z-50">
      {/* Location Top Left */}
      <div className="flex items-center gap-1.5 md:gap-2 text-foreground font-medium bg-white/95 md:bg-white/50 md:backdrop-blur-md px-3 py-1.5 md:px-4 md:py-2 rounded-full border border-white/60 shadow-sm text-xs md:text-sm">
        <MapPin size={16} className="text-primary" />
        <span className="whitespace-nowrap">Uttara, Dhaka</span>
      </div>

      {/* Username Pill Top Right */}
      <div className="flex items-center gap-1.5 md:gap-2 bg-white/95 md:bg-white/50 md:backdrop-blur-md px-3 py-1.5 md:px-4 md:py-2 rounded-full border border-white/60 shadow-sm">
